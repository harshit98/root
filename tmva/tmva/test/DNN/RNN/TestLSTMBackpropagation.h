                             ...
                             std::vector<bool> options = {}, bool debug = false)
{
    ...
    using Scalar_t = typename Architecture::Matrix_t;
    ...
    size_t outputSize = timeSteps * stateSize; // stateSize can be considered as cell state size.
    ...
    // Testing forget gate: input weights k = 2
    maximum_error = 0.0;
    ...
    // Testing candidate gate: input weights k = 4
    maximum_error = 0.0;
    ...
    // Testing output gate: input weights k = 6
    maximum_error = 0.0;
    ...
    // Testing input gate: state weights gradients k = 1
    maximum_error = 0.0;
    ...
    // Testing forget gate: state weights gradients k = 3
    maximum_error = 0.0;
